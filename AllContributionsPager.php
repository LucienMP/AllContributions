...
/**
 * Pager for Special:AllContributions
 * @ingroup Pager
 */
...
// Copied verbatim from Contrib; "includes/specials/pagers/ContribsPager.php"
//
class AllContributionsPager extends RangeChronologicalPager {
	...
	public function __construct( /*IContextSource $context,*/ array $options=null,
...
// LMP> Remove context data, and other related search data
//		parent::__construct( $context, $linkRenderer );
	...
	public function getDefaultQuery() {
		...
		// LMP> Remove targetted user, we want all editors
...
/* LMP> Remove user or ip search restrictions
...
*/
        // LMP> Select only a page; same as history for the page; not needed
        //$queryInfo['conds'][] = 'page_title = "Gdb"';
...
/*
 * LMP> Remove the "Username (talk)" and repalce with a use of the revUserTools
 *      which would generate "Username (talk|contrib)"
 * 
...
*/
			// Interestingly gives "Username (talk | contrib)"
			$userlink =  ' / ' . Linker::revUserTools( $revRecord, true, true );
